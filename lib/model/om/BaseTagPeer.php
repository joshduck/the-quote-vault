...
abstract class BaseTagPeer {
	...
	const ITEM_COUNT = 'tag.ITEM_COUNT';
	...
	private static $fieldNames = array (
		BasePeer::TYPE_PHPNAME => array ('Id', 'Name', 'ItemCount', ),
		BasePeer::TYPE_COLNAME => array (TagPeer::ID, TagPeer::NAME, TagPeer::ITEM_COUNT, ),
		BasePeer::TYPE_FIELDNAME => array ('id', 'name', 'item_count', ),
		BasePeer::TYPE_NUM => array (0, 1, 2, )
	);

	
	private static $fieldKeys = array (
		BasePeer::TYPE_PHPNAME => array ('Id' => 0, 'Name' => 1, 'ItemCount' => 2, ),
		BasePeer::TYPE_COLNAME => array (TagPeer::ID => 0, TagPeer::NAME => 1, TagPeer::ITEM_COUNT => 2, ),
		BasePeer::TYPE_FIELDNAME => array ('id' => 0, 'name' => 1, 'item_count' => 2, ),
		BasePeer::TYPE_NUM => array (0, 1, 2, )
	);
	...
	public static function addSelectColumns(Criteria $criteria)
	{
		...
		$criteria->addSelectColumn(TagPeer::ITEM_COUNT);
