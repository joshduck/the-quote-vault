...
abstract class BaseCategoryPeer {
	...
	private static $fieldNames = array (
		BasePeer::TYPE_PHPNAME => array ('Id', 'ParentCategoryId', 'Name', 'Slug', 'Listed', ),
		BasePeer::TYPE_COLNAME => array (CategoryPeer::ID, CategoryPeer::PARENT_CATEGORY_ID, CategoryPeer::NAME, CategoryPeer::SLUG, CategoryPeer::LISTED, ),
		BasePeer::TYPE_FIELDNAME => array ('id', 'parent_category_id', 'name', 'slug', 'listed', ),
		BasePeer::TYPE_NUM => array (0, 1, 2, 3, 4, )
	);

	
	private static $fieldKeys = array (
		BasePeer::TYPE_PHPNAME => array ('Id' => 0, 'ParentCategoryId' => 1, 'Name' => 2, 'Slug' => 3, 'Listed' => 4, ),
		BasePeer::TYPE_COLNAME => array (CategoryPeer::ID => 0, CategoryPeer::PARENT_CATEGORY_ID => 1, CategoryPeer::NAME => 2, CategoryPeer::SLUG => 3, CategoryPeer::LISTED => 4, ),
		BasePeer::TYPE_FIELDNAME => array ('id' => 0, 'parent_category_id' => 1, 'name' => 2, 'slug' => 3, 'listed' => 4, ),
		BasePeer::TYPE_NUM => array (0, 1, 2, 3, 4, )
	);
	...
	public static function addSelectColumns(Criteria $criteria)
	{
		...
		$criteria->addSelectColumn(CategoryPeer::LISTED);
